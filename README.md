...
- digo pero change → je dis mais je change
...
Prepositions are words that show relationships of place, time, direction, and more. Below are the most common Spanish prepositions, their French equivalents, and practical examples.

Core Prepositions Table
...
| con     | avec       | with             |
| sin     | sans       | without          |
| para    | pour       | for, in order to |
| por     | par        | by, through, for |
| sobre   | sur        | on, about        |
| entre   | entre      | between, among   |
| hacia   | vers       | toward           |
| desde   | depuis     | from, since      |
| hasta   | jusqu’à    | until, up to     |
| contra  | contre     | against          |


Examples by Preposition

**a / para / hacia** (to / for / toward)
...
**de / desde / hasta** (of, from / since / until)
...
**en / sobre / entre** (in, on / on, about / between)
...
**con / sin / contra** (with / without / against)
...
**por / para** (by, for / for, in order to)
...
**Idiomatic, Directional, and Filler Prepositions**
...
- trabajo junto a mis collègues → je travaille avec mes collègues
...
Below are high-frequency Spanish words with French translations, organized by theme for easy reference.
...
| vecina       | voisine              |
| amante       | amant                |
| compañero    | camarade / collègue  |
| compañera    | camarade / collègue  |
| jefe         | chef / patron        |
| jefa         | cheffe               |
| trabajador   | travailleur          |
| trabajadora  | travailleuse         |
| niñera       | nourrice             |
| doctor       | médecin              |
| doctora      | médecin              |
| profesor     | professeur           |
...
| restaurante rápido| fast-food            |
| hospital infantil | hôpital pour enfants |
...
Numbers
uno (un), dos (deux), tres (trois), cuatro (quatre), cinco (cinq), seis (six), siete (sept), ocho (huit), nueve (neuf), diez (dix), once (onze), doce (douze), trece (treize), catorce (quatorze), quince (quinze), veinte (vingt), treinta (trente), cuarenta (quarante), cincuenta (cinquante), cien (cent)

Colors
blanco/blanca (blanc/blanche), negro/negra (noir/noire), rojo/roja (rouge), azul (bleu), verde (vert), amarillo/amarilla (jaune), marrón/pardo (marron), gris (gris), naranja (orange), rosa (rose)

Time / Days / Months
hoy (aujourd’hui), mañana (demain), ayer (hier), día (jour), noche (nuit), semana (semaine), mes (mois), año (année), lunes (lundi), martes (mardi), miércoles (mercredi), jueves (jeudi), viernes (vendredi), sábado (samedi), domingo (dimanche), enero (janvier), febrero (février), marzo (mars), abril (avril), mayo (mai), junio (juin), julio (juillet), agosto (août), septiembre (septembre), octubre (octobre), noviembre (novembre), diciembre (décembre)
